...
// Then(/^I expect "(.*)" in draft is displayed$/, async (mailToField) => {
//     await draftMail.draftMailAdress(mailToField).waitForDisplayed();
//     expect (await draftMail.draftMailAdress(mailToField).isDisplayed()).is.equal(true);
// });
...
// Then(/^I expect "(.*)" in draft is NOT displayed$/, async (mailToField) => {
//     expect (await draftMail.draftMailAdress(mailToField).isDisplayed()).is.equal(false);
// }); 
